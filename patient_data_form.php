...
<html lang="en" xmlns="http://www.w3.org/1999/html">
    <head>
        ...
        <title>T2D and HT data collection form</title>
                ...
                <div class="row">
                    ...
                    <div class="form-header">
                        <div class="col-xs-8 col-sm-8 col-md-10">
                            <h2 class="text-center">T2D and HT data collection form</h2>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-headings"><!--/ .form-headings -->
                            ...
                            <form class="form-inline">
                                ...
                                <h3>2. <span>Index for T2D and HT:</span></h3>
                                ...
                                <div class="form-group only-bottom">
                                    <label for="t2D_diagnosed" class="control-label">T2D diagnosed :</label>
                                    <select name="t2D_diagnosed" class="form-control" tabindex="37">
                                        <option value="t2d_yes">Yes</option>
                                        <option value="t2d_no">No</option>
                                    </select>
                                </div><!--/ t2D_diagnosed  -->

                                <div class="form-group only-bottom">
                                    <label for="ht_diagnosed" class="control-label">HT diagnosed :</label>
                                    <select name="ht_diagnosed" class="form-control" tabindex="38">
                                        <option value="ht_yes">Yes</option>
                                        <option value="ht_no">No</option>
                                    </select>
                                </div><!--/ ht_diagnosed  -->

                                <div class="form-group only-bottom">
                                    <label for="both_diagnosed" class="control-label">Both :</label>
                                    <select name="both_diagnosed" class="form-control" tabindex="38">
                                        <option value="both_yes">Yes</option>
                                        <option value="both_no">No</option>
                                    </select>
                                </div><!--/ both_diagnosed  -->
                                ...
                                <div class="form-group only-bottom">
                                    <label for="t2D_or_ht_incidence" class="control-label">T2D or HT incidence of occurrence during diagnosis if any:</label>
                                    <input type="text" name="t2D_or_ht_incidence" class="form-control" tabindex="39">
                                </div><!--/ t2D_or_ht_incidence  -->

                                <br><br>

                                <div class="form-group only-bottom">
                                    <label for="other_medical_conditions" class="control-label">T2D or HT associated with other medical conditions :</label>
                                    <select name="other_medical_conditions" class="form-control" tabindex="40">
                                        <option value="other_cvd">CVD</option>
                                        <option value="other_obesity">Obesity</option>
                                        <option value="other_inflammatory_disease">Inflammatory disease</option>
                                    </select>
                                </div><!--/ other_medical_conditions  -->

                                <br><br>

                                <div class="form-group only-bottom">
                                    <label for="any_other_medical_conditions" class="control-label">Any other medical conditions:</label>
                                    <input type="text" name="any_other_medical_conditions" class="form-control" tabindex="41">
                                </div><!--/ any_other_medical_conditions  -->
